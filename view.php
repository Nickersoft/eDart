				...
				<div class="uk-grid uk-grid-preserve">
					<div class="uk-width-3-10">
						...
						<a href="#lightbox" data-uk-modal>
							<img class="image_body" style="background-image:url('/imageviewer/?id=<?php echo $_GET["itemid"]; ?>&size=thumbnail');" />
						</a>
						...
						<div id="offer_board">
							...
							<form id="po_form" action="/<?php echo $url; ?>" method="post">
								...
								<?php if(!$disallow_offers): ?>
									<select name= "offer" id="offerbox" class="chosen-select chosen-search" data-placeholder="Please select an item">
										<option></option>
						...
						?>
										<div class="offer" >
											<div class="uk-grid uk_grid_preserve reset_padding">
												...
												<div class="uk-width-3-10 post_date">
