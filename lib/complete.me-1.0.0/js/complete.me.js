...
function completely(container) {
    ...
    txtInput.className = 'cm-input';
    txtInput.type ='search';
    txtInput.spellcheck = false; 
    txtInput.name = container.getAttribute("name");
    txtInput.onKeyUp = function() { container.onKeyUp(); };
    txtInput.autocomplete = "off";
    
    var txtHint = txtInput.cloneNode(); 
    txtHint.disabled = '';        
    txtHint.className = 'cm-hint';
    txtHint.value = container.getAttribute("placeholder");
    txtInput.autocomplete = "off";
    ...
    dropDown.className="cm-dropdown";
        ...
        var p = {
            ...
            highlight : function(index) {
                if (oldIndex !=-1 && rows[oldIndex]) { 
                    rows[oldIndex].className = "cm-child";
                }
                rows[index].className += " cm-active"; // <-- should be config
                oldIndex = index;
            },
    ...
    var rs = { 
        ...
        repaint : function() {
            ...
            for (var i=0;i<optionsLength;i++) {
                var opt = options[i];
                if(token[0]&&token[0]==token[0].toLowerCase()) {
                	opt = opt.toLowerCase();
                }
