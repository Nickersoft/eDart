				...
				<div class="uk-grid">
					<div class="uk-width-medium-1-5">
						<ul id="about_nav" class="uk-nav uk-nav-side" data-switcher-parent="#panel_parent">
						    ...
						    <hr/>
						    <li class="uk-text-center uk-hidden-small" style="white-space:normal;letter-spacing:1px;color:#B8B8B8;"><span><?php echo number_format($total); ?> Lines of Awesome</span></li>
						</ul>
					</div>
